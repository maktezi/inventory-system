...
<div class="row">
    <div class="col-6 mx-auto">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">ADD INVENTORY</h4>
...
<div class="col-xl-6 mx-auto">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('store.inventory') }}" method="POST" class="needs-validation">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div data-date-autoclose="true">
                                <input type="number" class="form-control" name="stocks" placeholder="" required/>
                            </div>
                        </div>
                    </div>
