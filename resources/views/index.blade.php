...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <a href="/" class="logo me-auto"><img src="{{ asset('applogo.png') }}" alt="" class="img-fluid"></a>

      <nav id="navbar" class="navbar">
        <ul>
            <li><a class="nav-link scrollto active" style="font-weight: 900;" href="/">Home</a></li>
            @if (Route::has('login'))
                @auth
                    <li><a href="{{ url('home') }}" style="font-weight: 900;" class="nav-link scrollto">Dashboard</a></li>
                ...
                @else
                    <li><a href="{{ route('login') }}" class="nav-link scrollto" style="font-weight: 900;">Log in</a></li>

                    @if (Route::has('register'))
                        <li><a href="{{ route('register') }}" class="nav-link scrollto" style="font-weight: 900;">Register</a></li>
                    @endif
                @endauth
            @endif
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>Provides detailed records of new and stock products.</h2>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="{{ url('home') }}" class="btn-get-started scrollto">Enter</a>
          </div>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="footer-newsletter" style="background-color: #557B83">
    </div>

    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>IT Devs</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        Developed by <a href="#">IT Devs</a>
      </div>
    </div>
  </footer>
